...
2. Render te dará una URL tipo: `https://mta-api-gara.onrender.com`
3. Abrir esa URL en el navegador, debería mostrar los endpoints disponibles
4. Probar: `https://mta-api-gara.onrender.com/api/status`
...
```lua
API_URL = "https://mta-api-gara.onrender.com"
```
